		...
		<div class="invoice-box rtl">
			<table cellpadding="0" cellspacing="0" class="rtl">
				...
				<tr class="heading">
                    ...
                    <td class="td-column">{{__('app.the_type')}}</td>
                    <td class="td-column">{{__('app.sacks_number')}}</td>
                    <td class="td-column">{{__('app.number_kilo')}}</td>
				</tr>
                @foreach ($stocks as $stock)
                <tr class="details">
                    <td class="td-column">{{$stock->productRelation->productName}}</td>
                    <td class="td-column">{{$stock->typeRelation->type}}</td>
                    <td class="td-column">{{$stock->number_kilo}}</td>
                    <td class="td-column">{{$stock->sacks_number}}</td>
				</tr>
                @endforeach
			</table>
		</div>
