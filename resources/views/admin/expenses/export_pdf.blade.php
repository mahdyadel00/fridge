			...
			<table cellpadding="0" cellspacing="0" class="rtl">
				<tr class="top">
                    ...
                    <tr class="heading">
                        ...
                        <td class="special">{{__('app.notes')}}</td>
                       </tr>
                       @foreach ($expenses as $expense)
                       <tr class="details">
                           <td class="td-column">{{__('app.' . $expense->type)}}</td>
                           <td class="td-column">{{$expense->amount}}</td>
                           <td class="td-column">{{$expense->date}}</td>
                           <td class="special">{{$expense->notes}}</td>
                       </tr>
                       @endforeach
